...
export default function App() {
  ...
  const skillsCategories = [
    ...
    {
      title: 'Frontend Development & Design',
      icon: Layout,
      skills: ['HTML', 'CSS', 'React.js', 'Next.js', 'Canva', 'Figma'],
    },
    {
      title: 'Backend Development',
      icon: Database,
      skills: ['Node.js', 'Express.js', 'Flask', 'REST APIs', 'FastAPI'],
    },
    {
    ...
    },
    {
      title: 'DevOps & Cloud',
      icon: Wrench,
      skills: ['Docker', 'Google Cloud Platform', 'CI/CD', 'Git', 'GitHub'],
    },
    {
      title: 'AI/ML',
      icon: Brain,
      skills: ['PyTorch', 'Scikit-learn', 'OpenCV', 'Pandas', 'NumPy', 'RAG'],
    },
  ];

  const projects = [
    {
      title: 'PollFlow - Secure College Polling System',
      description: 'Secure polling platform with role-based access control across student, staff, and administrator tiers, featuring automated poll scheduling and real-time result analytics. Deployed to production, serving 1,000+ students and 25 staff across 15 campus sections.',
      tech: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Supabase', 'Google OAuth'],
      github: 'https://github.com/S-Sivahari/CIT_Polling_System',
      image: PollingImg,
    },
    {
      title: 'SENTINEL-AI - Real-Time Perimeter Threat Detection',
      description: 'Real-time perimeter threat detection system with multi-zone intrusion detection, object tracking, and tripwire crossing across image, video, webcam, and URL inputs. Achieved 84% mAP50 accuracy across YOLOv8 models, integrating ByteTrack for persistent live multi-object tracking.',
      tech: ['Python', 'Flask', 'YOLOv8', 'ByteTrack', 'OpenCV', 'Docker'],
      github: 'https://github.com/S-Sivahari/SENTINEL-AI',
      image: SentinelAIImg,
    },
    {
      title: 'F.L.O.W - IC Layout Workflow Management System',
      description: 'MERN workflow platform replacing spreadsheet-based tracking for analog IC layout teams, with three-role access control (Admin/Manager/Engineer) and a six-stage approval pipeline logging every transition to an audit trail. Features an interactive dependency graph computing the project critical path via DFS with cycle detection, plus a Socket.IO layer delivering live dashboard updates.',
      tech: ['Node.js', 'Express', 'React', 'MongoDB', 'Socket.IO', 'Google OAuth'],
      github: 'https://github.com/S-Sivahari/F.L.O.W.git',
      image: FlowImg,
    },
    {
      title: 'SynthoCAD - AI-Assisted CAD Workspace',
      description: 'AI-assisted CAD workspace transforming natural-language prompts into editable parametric models and STEP exports, orchestrating a self-repairing generation pipeline with iterative validation. Engineered RAG over 300+ CAD templates using ChromaDB and sentence-transformers, plus a Three.js 3D workspace for live STEP preview and in-place editing.',
  ...
  const experience = [
    {
      ...
      description: 'Collaborated within a team of 6 to architect and ship a production grade HR management platform for 50+ users using React, Node.js, TypeScript, and MongoDB Atlas, automating payroll, leave, timesheets, and analytics deployed on Google Cloud Run via a Dockerized Cloud Build CI/CD pipeline.',
      highlights: [
        'Automated builds and releases on every commit via a Dockerized Cloud Build CI/CD pipeline',
        'Re-architected two independent services into a unified deployment to eliminate cross-origin overhead',
        'Hardened the system with Google OAuth, JWT authentication, and CSRF protection',
      ],
    },
    {
      ...
      description: 'Architected SynthoCAD, an AI-assisted CAD workspace leveraging Python, Flask, and Gemini to transform natural-language prompts into editable parametric models and STEP exports, orchestrating a self-repairing generation pipeline with iterative validation and sandboxed execution on failure.',
      highlights: [
        'Engineered RAG over 300+ CAD templates using ChromaDB and sentence-transformers to ground model generation in real components',
        'Developed a Three.js 3D workspace enabling live STEP preview, spatial inspection, and in-place editing',
      ],
    },
  ];
  ...
  const achievements = [
    {
      title: "HackHazards '26 - 2nd Place, Sarvam AI Track",
      organization: 'Global Top 25 of 2,657 projects, NAMESPACE',
      year: 'Aug 2026',
    },
    {
      title: 'NextGenHacks 2026 - Finalist',
      organization: 'Top 9 of 2,500+ participants nationwide, NextGenHacks',
      year: 'Jul 2026',
    },
    {
      title: 'ELPL Build-A-Thon 2.0 - 2nd Prize',
      organization: 'Internship offer, Epical Layouts',
      year: 'May 2026',
    },
    {
      title: 'Smart India Hackathon 2025 - Top 50 Team',
      organization: 'Internal selection round',
      year: 'Nov 2025',
    },
  ];
